...
import jpabookRepeat.jpashopRepeat.domain.Order;
import jpabookRepeat.jpashopRepeat.domain.OrderStatus;
import jpabookRepeat.jpashopRepeat.domain.item.Book;
import jpabookRepeat.jpashopRepeat.domain.item.Item;
import jpabookRepeat.jpashopRepeat.exception.NotEnoughStockException;
import jpabookRepeat.jpashopRepeat.repository.OrderRepository;
